...
export function NavBar() {
  ...
  return (
    <NavbarBs className=" shadow-sm mb-3" style={{ backgroundColor: "#ddd" }}>
      <Container>
        <Nav className="me-auto">
          <Nav.Link to="/category" as={NavLink} className="navbarEl">
            CateGory
          </Nav.Link>
          <Nav.Link to="/store" as={NavLink} className="navbarEl">
            All Items
          </Nav.Link>
        </Nav>
        {/* {cartQuantity > 0 && ( */}
